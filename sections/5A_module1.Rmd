...
Ces slides en ligne : http://datactivist.coop/SPoSGL/5A_module1.html
...
#### 1. Les transactions de données
#### 2. Le cas Google
#### 3. Les freins du RGPD européen
#### 4. Des exemples d'échanges de données
...
.pull-right[.center[Voir l'[infographie complète](https://ec.europa.eu/info/law/law-topic/data-protection/reform/rules-business-and-organisations/principles-gdpr_fr)]]
...
.center[<img src="./img/ddi_michelin.png" height="400"/>] 
...
.center[<img src="./img/fluxvision_orange.png" height="400"/>]
