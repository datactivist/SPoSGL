...
Lire le papier de recherche ["L'Open Data: universalité du principe et diversité des expériences?"](https://hal.archives-ouvertes.fr/hal-01026106/document) par Danièle Bourcier et Primavera De Filippi
...
> La moitié des descriptions des jeux de données fait moins de 180 caractères
4% des jeux de données ont une description supérieure à 1000 caractères soit moins d’une demi-page
